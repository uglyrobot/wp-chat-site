...
export default function Home() {
  ...
  const saveKey = (e) => {
    e.preventDefault()
    setOpenAIKey(e.target.openAIKey.value)
  ...
  const askQuestion = async () => {
    ...
    if (openAIKey) {
      body.append('openai_api_key', openAIKey)
    }

    try {
      const response = await fetch('https://chatwp.uc.r.appspot.com/ask', {
        method: 'POST',
        headers: {
              ...
              <div className="mx-auto max-w-md px-6 text-center sm:max-w-3xl lg:max-w-7xl lg:px-8">
                <div>
                  ...
                  <p className="mx-auto mt-5 max-w-prose text-xl text-gray-500">
                    Ask me anything about WordPress and I'll do my best to
                    answer! Be sure to check my sources as I might occassionally
                    make things up!{' '}
                ...
                <div className="mt-12">
                  <Alert title={errorText} type="error">
                    {showKeyModal && (
                      <>
                      <div className="mt-2 max-w-2xl text-sm text-left">
                        <p>Sorry, but GPT API costs add up quickly so we have to limit requests per user. Enter your OpenAI API key to bypass our daily limits. You can <Link target="_blank" href="https://openai.com/api/" className="underline">create a free account</Link> to <Link target="_blank" href="https://platform.openai.com/account/api-keys" className="underline">get your own key</Link>. You key will only be stored locally and not saved or logged in our servers.</p>
                      </div>
                      <form className="mt-5 sm:flex sm:items-center" onSubmit={saveKey}>
                        <div className="w-full sm:max-w-xs">
                          ...
                          <input
                            ...
                            required
                            className="block px-4 py-2 w-full rounded-md text-black border-gray-500 shadow-sm focus:border-cyan-500 focus:ring-cyan-500 sm:text-sm"
            ...
            <div className="relative bg-white pt-16 pb-12 sm:pt-24 lg:pt-32">
              <div className="mx-auto max-w-md px-6 text-center sm:max-w-3xl lg:max-w-7xl lg:px-8">
                ...
                <p className="mx-auto mt-5 max-w-7xl text-xl text-gray-500">
                  ...
                  posts, or any other content with just a few clicks. And the
                  best part? Our intuitive interface makes it a breeze to create
                  your own Q&A and chatbots from it that can be integrated into
                  your website, app/plugin, Slack, or anywhere else you want to
                  use them, all through our simple API. Don't miss out on this
                  exciting opportunity to revolutionize the way you interact
                  with your customers.{' '}
